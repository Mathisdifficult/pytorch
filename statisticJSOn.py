...
T2Dv2="/Users/ylz/ylz/web_table_database/T2Dv2/converted"
...
def roughly_statistic_json(folder_path):
...
for file in scan_folder(T2Dv2):
    l+=roughly_statistic_json(file)
    l+="\n"
    # i+=1
    # if i%100==10:
    #     l.append(file)
